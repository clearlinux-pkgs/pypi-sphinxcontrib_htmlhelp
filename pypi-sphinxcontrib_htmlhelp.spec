...
Source0  : https://files.pythonhosted.org/packages/92/d9/a1c50c8a7b5e12f34bf4d63300a1e2629c29b71603115d900c0fa7c79219/sphinxcontrib_htmlhelp-2.0.6.tar.gz
...
%prep
%setup -q -n sphinxcontrib_htmlhelp-2.0.6
cd %{_builddir}/sphinxcontrib_htmlhelp-2.0.6
pushd ..
cp -a sphinxcontrib_htmlhelp-2.0.6 buildavx2
popd
pushd ..
cp -a sphinxcontrib_htmlhelp-2.0.6 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721664749
