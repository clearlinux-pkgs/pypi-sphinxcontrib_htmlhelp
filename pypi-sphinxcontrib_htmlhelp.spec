...
%prep
%setup -q -n sphinxcontrib_htmlhelp-2.1.0
cd %{_builddir}/sphinxcontrib_htmlhelp-2.1.0
pushd ..
cp -a sphinxcontrib_htmlhelp-2.1.0 buildavx2
popd
pushd ..
cp -a sphinxcontrib_htmlhelp-2.1.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722276288
...
cp %{_builddir}/sphinxcontrib_htmlhelp-%{version}/LICENCE.rst %{buildroot}/usr/share/package-licenses/pypi-sphinxcontrib_htmlhelp/7477e3e4ce73d4501e4086813a0d88b153ab4423 || :
