...
Source0  : https://files.pythonhosted.org/packages/8a/03/2f9d699fbfdf03ecb3b6d0e2a268a8998d009f2a9f699c2dcc936899257d/sphinxcontrib_htmlhelp-2.0.5.tar.gz
...
%prep
%setup -q -n sphinxcontrib_htmlhelp-2.0.5
cd %{_builddir}/sphinxcontrib_htmlhelp-2.0.5
pushd ..
cp -a sphinxcontrib_htmlhelp-2.0.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705166219
